...
const detailsURL = "http://localhost:3001/visuaimport { clamp_value, create_example, feature_dists_order, pretty_value, unscale } from '../../../../visualization/src/utilities.js';
import { ExplanationTypes, OFFSET_UNSCALED, expl_colors, rect_values } from "../../../../visualization/src/values.js";
import { json, select } from "d3";
import { RangeTypes } from "./numberLineUtil.js";
...
export const numberLineBuilder = (explanation, index) => {
    ...
    return my;
}lization/data/dataset_details.json";
const readableURL = "http://localhost:3001/visualization/data/human_readable_details.json";
