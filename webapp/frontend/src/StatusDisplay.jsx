...
export const StatusDisplay = ({ featureDict, formatDict, selectedInstance, status }) => {
    ...
    const updateData = () => {
        const dataRow = Object.keys(selectedInstance)//selectedInstance[currentIndex];
        ...
        for (let key of dataRow) {
            if (selectedInstance.hasOwnProperty(key)) {
                const div1 = document.createElement('div');
                const div2 = document.createElement('div');
                const dataValue = selectedInstance[key] ? selectedInstance[key] : '0';
    ...
    useEffect(() => {
        setNumberOfRows(Object.keys(selectedInstance).length);
        updateData();
    }, [currentIndex, selectedInstance, status]);
