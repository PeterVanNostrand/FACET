...
import time
import numpy as np
from baselines.mace.modelConversion import forest2formula
from baselines.mace.normalizedDistance import getDistanceBetweenSamples
    ...
    while iters < max_iters and norm_upper_bound - norm_lower_bound >= epsilon:
        ...
        with Solver(name=solver_name) as solver:
            ...
            if solved:  # joint formula is satisfiable
                ...
                counterfactual_distance = getDistanceBetweenSamples(
                    factual_sample,
                    counterfactual_sample,
                    norm_type,
                    dataset_obj)
                interventional_distance = getDistanceBetweenSamples(
                    factual_sample,
                    interventional_sample,
                    norm_type,
                    dataset_obj)
