            ...
            for norm_type_string in norm_values:
                ...
                for approach_string in approaches_values:
                    ...
                    if gen_cf_for == 'neg_only':
                        # choose only a subset to compare
                        iterate_over_data_df = neg_pred_data_df[batch_start_index: batch_end_index]
                        observable_data_df = pos_pred_data_df
                    elif gen_cf_for == 'pos_only':
                        # choose only a subset to compare
                        iterate_over_data_df = pos_pred_data_df[batch_start_index: batch_end_index]
                        observable_data_df = neg_pred_data_df
                    elif gen_cf_for == 'neg_and_pos':
                        # choose only a subset to compare
                        iterate_over_data_df = all_pred_data_df[batch_start_index: batch_end_index]
